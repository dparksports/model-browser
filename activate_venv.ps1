...
Write-Host ""
Write-Host "  2. DETECT MEETINGS" -ForegroundColor Green
Write-Host "     python detect_meetings.py --model pick   # pick from downloaded models"
Write-Host "     python detect_meetings.py                # uses last picked model"
Write-Host "     python detect_meetings.py --skip-checked # resume a previous scan"
Write-Host ""
Write-Host "  3. CLOUD PROVIDERS (optional)" -ForegroundColor Green
Write-Host "     python detect_meetings.py --provider gemini --api-key KEY"
Write-Host "     python detect_meetings.py --provider openai --api-key KEY"
Write-Host "     python detect_meetings.py --provider claude --api-key KEY"
Write-Host ""
